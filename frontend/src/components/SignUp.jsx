  ...
  return (
    ...
    style={{backgroundColor: bgColor}}>
        ...
        border`} style={{border:`1px solid ${borderColor}`}}>
            ...
            <p> Create your account to get started with our delicious food deliveries! </p>
            ...
            <form className='mt-6 flex flex-col gap-4'>
                ...
                <input type="text" name="name" onChange={handleChange} value={formData.name} className='w-full border rounded-lg px-3 py-2
                ...
                <input type="text" name="email" onChange={handleChange} value={formData.email} className='w-full border rounded-lg px-3 py-2
                focus:border-orange-400'
                ...
                <input type="number" name="mobile" onChange={handleChange} value={formData.mobile} className='w-full border rounded-lg px-3 py-2
                focus:border-orange-400'
                ...
                hover:bg-orange-400 hover:text-gray-200 cursor-pointer hover:underline'>SignUp Now</button>
